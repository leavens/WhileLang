...
@after {
	...
	(
		{
			newCompositeNode(grammarAccess.getExpressionAccess().getBConjParserRuleCall_0());
		}
		...
		(
			...
			(
				(
					lv_op_2_0=RULE_OR
					{
						newLeafNode(lv_op_2_0, grammarAccess.getExpressionAccess().getOpORTerminalRuleCall_1_1_0());
					}
					{
						if ($current==null) {
